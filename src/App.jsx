            ...
            <div className="relative rounded-[2rem] border border-white/10 bg-white/[0.04] p-5 shadow-2xl shadow-black/40">
              <div className="rounded-[1.5rem] border border-red-300/20 bg-zinc-950 p-7">
                <div className="mx-auto flex max-w-md flex-col items-center text-center">
                  ...
                  <p className="mt-6 text-sm font-black uppercase tracking-[0.28em] text-red-300">Access Enforcement Division</p>
                  <p className="mt-4 text-zinc-300">
                    802.1X, MAB, EAP-TLS, PKI, posture, profiling, quarantine, guest access, and Zero Trust segmentation for the real endpoints nobody warned you about.
                  </p>
                </div>
